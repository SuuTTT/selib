...
def main():
    ...
    if os.path.exists(cmp_path):
        ...
        cmp_block = (
            ...
            "survey campaign's numbers. (Its successor <b>deDoc2</b> is excluded here: it only "
            "forms <i>contiguous</i> TAD-like domains over genomically-ordered bins, so on a "
            "general graph it groups consecutive node IDs and ignores the topology — a Hi-C tool, "
            "not a community detector.)</p>"
...
<a href="maps.html"><b>survey maps</b></a> ·
