...
and returns the tree with the lowest structural entropy. Equation~\eqref{eq:nni-delta}
scores every candidate rotation exactly, while a full recomputation of
