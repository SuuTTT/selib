...
$O(3^n)$ exact dynamic program and, for the first time in this comparison, a
...
better of HCSE and BBM and wins all paired comparisons. On 50 independently
generated 12-vertex instances, it reaches the exact global optimum in
\ExactOptima{} cases; its mean relative gap is \ExactMeanRelativeGap{} and its
maximum is \ExactMaxRelativeGap{}. These exact-instance results certify observed
