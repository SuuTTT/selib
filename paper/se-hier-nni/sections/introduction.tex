...
without inspecting labels or the exact optimum. We additionally specialize a
subset-trellis dynamic program to compute the global optimum for small graphs.
...
\begin{itemize}
  ...
  \item a binary-refinement theorem, an SE-specific $O(3^n)$ subset-trellis
  optimizer for small graphs, and an exact audit of \NEST's optimality gap; and
...
comparison. On a frozen 250-graph confirmation suite, \NEST-R with 32 random
starts reaches the global optimum in \ExactOptima{} cases, compared with
\BaselineExactOptima{} for the standard candidate pool. This is an empirical
